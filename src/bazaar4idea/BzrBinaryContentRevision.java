...
public class BzrBinaryContentRevision extends BzrContentRevision implements BinaryContentRevision {
  public BzrBinaryContentRevision(@NotNull FilePath file, @NotNull BzrRevisionNumber revision,
  ...
  public byte[] getBinaryContent() throws VcsException {
    ...
    return BzrFileUtils.getFileContent(myProject, root, myRevision.toString(),
                                       VcsFileUtil.relativePath(root, myFile));
  }
}
