 ...
 * </p>
 * <p>
 *   GitRemote instance constructed by {@link BzrConfig#read(BzrPlatformFacade, java.io.File)}} has all these rules applied.
...
public final class BzrRemote implements Comparable<BzrRemote> {
   ...
   * Usually all Bazaar repositories have an "origin" remote, so it can be used as a default value in some cases.
   */
  ...
  BzrRemote(@NotNull String name, @NotNull List<String> urls, @NotNull Collection<String> pushUrls,
  ...
  public boolean equals(Object o) {
    ...
    BzrRemote bzrRemote = (BzrRemote)o;
