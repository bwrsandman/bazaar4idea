...
//    optionsPanel.add(myRefspecPanel);
  ...
  protected String getHelpId() {
    return "reference.VersionControl.Bzr.PushDialog";
  }
...
//        targetBranch = BzrBranchUtil.findRemoteBranchByName(trackedBranchName, remote.getName(),
...
//        BzrRemoteBranch manualBranch = BzrBranchUtil.findRemoteBranchByName(manualBranchName, remote.getName(),
//                                                                            repository.getBranches().getRemoteBranches());
...
//  }
  ...
  public JComponent getPreferredFocusedComponent() {
    return null; //myListPanel.getPreferredFocusComponent();
  }
