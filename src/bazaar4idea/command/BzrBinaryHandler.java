...
public class BzrBinaryHandler extends BzrHandler {
   ...
   */
  protected BzrBinaryHandler(@NotNull Project project, @NotNull File directory,
                             @NotNull BzrCommand command) {
   ...
   * @throws com.intellij.openapi.vcs.VcsException in case of the problem with running git
   */
