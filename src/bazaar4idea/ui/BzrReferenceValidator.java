  ...
  public BzrReferenceValidator(final Project project,
    ...
    myButton.addActionListener(new ActionListener() {
      public void actionPerformed(final ActionEvent e) {
        ...
        myLastResult = false;
        try {
          BzrRevisionNumber revision = BzrRevisionNumber.resolve(myProject, bzrRoot(), revisionExpression);
          BzrUtil.showSubmittedFiles(myProject, revision.asString(), bzrRoot(), false, false);
          myLastResult = true;
        }
