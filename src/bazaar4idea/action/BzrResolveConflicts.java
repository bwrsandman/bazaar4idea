...
public class BzrResolveConflicts extends BzrAction {
  @Override
  public void actionPerformed(@NotNull AnActionEvent event) {
    ...
    AbstractVcsHelper.getInstance(project).showMergeDialog(new ArrayList<VirtualFile>(conflictedFiles),
                                                           BzrVcs.getInstance(project).getMergeProvider());
