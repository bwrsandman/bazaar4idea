...
public class BzrExecutableDetector {
    ...
    for (String programFiles : PROGRAM_FILES) {
      ...
      File[] children = pf.listFiles(new FileFilter() {
        ...
        public boolean accept(File pathname) {
          return pathname.isDirectory() && pathname.getName().toLowerCase().startsWith("bzr");
        }
      });
  ...
  private static String checkCygwin() {
    final String[] OTHER_WINDOWS_PATHS = { FileUtil.toSystemDependentName("cygwin/bin/bzr.exe") };
