...
//  }
  ...
  /**
   * Update remotes for the Bazaar root
   */
...
//    BzrBranchTrackInfo trackInfo = GitUtil.getTrackInfoForCurrentBranch(repository);
//    if (trackInfo != null) {
...
//    }
   ...
   */
  public ListCellRendererWrapper<BzrRemote> getGitRemoteListCellRenderer(final String defaultRemote) {
    return new ListCellRendererWrapper<BzrRemote>() {
      @Override
      public void customize(final JList list, final BzrRemote remote, final int index, final boolean selected,
