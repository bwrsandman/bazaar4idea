...
//  @NotNull private final Set<BzrBranchTrackInfo> myBranchTrackInfos;
  ...
  public BzrRepoInfo(/*@Nullable BzrLocalBranch currentBranch, */@Nullable String currentRevision, @NotNull Repository.State state,
                     @NotNull Collection<BzrRemote> remotes/*, @NotNull Collection<BzrLocalBranch> localBranches,
