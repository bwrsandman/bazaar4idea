...
public class BzrHandlerUtil {
   ...
   */
  @Nullable
  public static String doSynchronously(final BzrSimpleHandler handler, String operationTitle,
  ...
  public static void runInCurrentThread(final BzrHandler handler,
    ...
    runInCurrentThread(handler, new Runnable() {
      public void run() {
        if (indicator != null) {
          indicator.setText(operationName == null ? BzrBundle.message("bzr.running", handler.printableCommandLine())
                                                  : operationName);
          indicator.setText2("");
   ...
   */
  private abstract static class BzrLineHandlerListenerBase extends BzrHandlerListenerBase
                                                           implements BzrLineHandlerListener {
    /**
     * A constructor
     *
     * @param handler       a handler instance
  ...
  public static class BzrLineHandlerListenerProgress extends BzrLineHandlerListenerBase {
     ...
     * @param showErrors    if true, the errors are shown when process is terminated
     */
    public BzrLineHandlerListenerProgress(final ProgressIndicator manager, BzrHandler handler, String operationName,
                                          boolean showErrors) {
