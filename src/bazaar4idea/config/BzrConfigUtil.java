...
public class BzrConfigUtil {
   ...
   * @return list of pairs ({@link com.intellij.openapi.util.Pair#first} is the key, {@link com.intellij.openapi.util.Pair#second} is the value)
   * @throws com.intellij.openapi.vcs.VcsException an exception
   */
