...
//    if (BzrHttpAdapter.shouldUseJBzr(url)) {
...
//        BzrConfigUtil.setValue(project, root, "branch." + branchName + ".merge",
//                               BzrBranch.REFS_HEADS_PREFIX + dest.getNameForRemoteOperations());
//        if (rebase) {
...
//            final BzrRejectedPushUpdateDialog dialog = new BzrRejectedPushUpdateDialog(myProject, rejectedPushesForCurrentBranch.keySet(), updateSettings);
