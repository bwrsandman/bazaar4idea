...
public final class BzrCommit extends VcsFullCommitDetailsImpl {
  ...
  public BzrCommit(final Project project, @NotNull Hash hash, @NotNull List<Hash> parents, long time,
                   @NotNull VirtualFile root, @NotNull String subject, @NotNull VcsUser author, @NotNull String message,
                   @NotNull VcsUser committer, long authorTime, @NotNull List<Change> changes) {
