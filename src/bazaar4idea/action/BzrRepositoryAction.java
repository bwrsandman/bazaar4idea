...
public abstract class BzrRepositoryAction extends DumbAwareAction {
   ...
   * false if the task is responsible to call the final tasks manually via {@link #runFinalTasks(Project, BzrVcs, Set, String, List)}.
   */
   ...
   * @throws com.intellij.openapi.vcs.VcsException if there is a problem with running git (this exception is considered to be added to the end of the exception list)
   */
